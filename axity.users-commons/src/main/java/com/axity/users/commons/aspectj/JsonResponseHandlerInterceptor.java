...
import com.axity.users.commons.exception.ValidationException;
import com.axity.users.commons.response.GenericResponseDto;
import com.axity.users.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.axity.users.controller.*.*(..))"
      + " and @annotation(com.axity.users.commons.aspectj.JsonResponseInterceptor)")
